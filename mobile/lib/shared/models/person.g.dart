...
Person _personDeserialize(
  ...
  final object = Person(
    ...
    remoteId: reader.readStringOrNull(offsets[1]),
  );
  object.id = id;
  return object;
}
...
extension PersonQueryWhere on QueryBuilder<Person, Person, QWhereClause> {
  ...
  QueryBuilder<Person, Person, QAfterWhereClause> remoteIdIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterWhereClause> remoteIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension PersonQueryFilter on QueryBuilder<Person, Person, QFilterCondition> {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> remoteIdIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> remoteIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
